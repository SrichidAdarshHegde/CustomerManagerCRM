...
@Component({
  selector: 'app-quotation5030z25jlx',
  templateUrl: './quotation5030z25jlx.component.html',
  styleUrls: ['./quotation5030z25jlx.component.css']
})
export class Quotation5030z25jlxComponent {
 ...
 TemplateName: string = "Quotation Quotation 5030=-Z25-JLX";
  BasicSystemQty: string = '1 Set';
  BasicSystemPrice: number =1205000       ; 
...
getBillingAddress(){
  ...
  fetchTemplate() {
    this.regSv.gettemplatedetails5030z25jlx(this.RefID).subscribe((response: any) => {
  ...
  KindAttention:this.KindAttention,
    ...
    this.regSv.postSavequotationtemplate5030Z25ZLX(templateData).subscribe((response:any )=>
    {
      if(response !=null){
