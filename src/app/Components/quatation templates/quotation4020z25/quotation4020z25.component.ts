...
@Component({
  selector: 'app-quotation4020z25',
  templateUrl: './quotation4020z25.component.html',
  styleUrls: ['./quotation4020z25.component.css']
})
export class Quotation4020z25Component {
 ...
 TemplateName: string = "Quotation 4020-Z25";
  BasicSystemQty: string = '1 Set';
  BasicSystemPrice: number =940000     ; 
...
getBillingAddress(){
  ...
  fetchTemplate() {
    this.regSv.gettemplatedetails4020z25(this.RefID).subscribe((response: any) => {
  ...
  KindAttention:this.KindAttention,
    ...
    this.regSv.postSavequotationtemplate4020Z25(templateData).subscribe((response:any )=>
    {
      if(response !=null){
