...
@Component({
  selector: 'app-quotation2015',
  templateUrl: './quotation2015.component.html',
  styleUrls: ['./quotation2015.component.css']
})
export class Quotation2015Component {
  ...
  IsLoggedIn: any;
  RefID:any ;
  TemplateName: string = "Quotation 2015";
  ...
  BasicSystemPrice: number =697000  ; 
...
getBillingAddress(){
  ...
  TemplateName:this.TemplateName,
    ...
    this.regSv.postSavequotationtemplate2015(templateData).subscribe((response:any )=>
    {
      if(response !=null){
