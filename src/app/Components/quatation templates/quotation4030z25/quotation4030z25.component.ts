...
export class Quotation4030z25Component {
  ...
  selectedcustID: any;
  customerdata: any;
  TemplateName: string = "Quotation 4030-Z25";
...
KindAttention: any;
 ...
 getBillingAddress(){
   ...
   fetchTemplate() {
    this.regSv.gettemplatedetails4030z25(this.RefID).subscribe((response: any) => {
   ...
   KindAttention:this.KindAttention,
     ...
     this.regSv.postSavequotationtemplate4030Z25(templateData).subscribe((response:any )=>
     {
       if(response !=null){
