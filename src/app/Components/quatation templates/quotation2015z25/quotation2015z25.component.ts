...
@Component({
  selector: 'app-quotation2015z25',
  templateUrl: './quotation2015z25.component.html',
  styleUrls: ['./quotation2015z25.component.css']
})
export class Quotation2015z25Component {
  ...
  selectedcustID: any;
  customerdata: any;
  TemplateName: string = "Quotation 2015Z25";
  BasicSystemQty: string = '1 Set';
  BasicSystemPrice: number =817000   ; 
...
getBillingAddress(){
  ...
  fetchTemplate() {
    this.regSv.gettemplatedetails2015z25(this.RefID).subscribe((response: any) => {
  ...
  KindAttention:this.KindAttention,
    ...
    this.regSv.postSavequotationtemplate2015Z25(templateData).subscribe((response:any )=>
    {
      if(response !=null){
