...
@Component({
  selector: 'app-quotation4030',
  templateUrl: './quotation4030.component.html',
  styleUrls: ['./quotation4030.component.css']
})
export class Quotation4030Component {
  ...
  selectedcustID: any;
  customerdata: any;
  TemplateName: string = "Quotation 4030";
  BasicSystemQty: string = '1 Set';
  BasicSystemPrice: number =950000     ; 
...
getBillingAddress(){
  ...
  fetchTemplate() {
    this.regSv.gettemplatedetails4030(this.RefID).subscribe((response: any) => {
  ...
  KindAttention:this.KindAttention,
    ...
    this.regSv.postSavequotationtemplate4030(templateData).subscribe((response:any )=>
    {
      if(response !=null){
