...
@Component({
  selector: 'app-q4020',
  templateUrl: './q4020.component.html',
  styleUrls: ['./q4020.component.css']
})
export class Q4020Component {
  @ViewChild('table', { static: false }) table!: ElementRef;
  exporting:boolean=false;
  TemplateName: string = "Quotation 4020";
...
//editable
 ...
 editableQtyF:number=1;
  ...
  BasicSystemPrice: number= 820000; 
