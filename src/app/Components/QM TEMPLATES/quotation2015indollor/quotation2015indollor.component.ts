...
@Component({
  selector: 'app-quotation2015indollor',
  templateUrl: './quotation2015indollor.component.html',
  styleUrls: ['./quotation2015indollor.component.css']
})
export class Quotation2015indollorComponent {
...
//editable
 ...
 editableQtyF:number=1;
  editablePriceF:number=3500;

  editableQtyG:number=1;
  editablePriceG:number=4200;

  editableQtyH:number=1;
  editablePriceH:number=1349;
  ...
  OptionalPriceH: number = 1349; 

  TemplateName: string = "Quotation 2015 IN DOLLOR";
  CustomerName:any;
  KindAttention: any;
  TotalAmount: number;
...
getBillingAddress(){
  ...
  TotalAmount:this.TotalAmount,
    ...
    this.regSv.postSavequotation2015indollar(templateData).subscribe((response:any )=>
    {
      if(response !=null){
