...
export class FttCoveringLetterComponent {
  ...
  print (printSectionId) {
    ...
    popupWinindow.document.write('<html> <head><style> '+ '.sign{text-align:right;margin-left:-25px} '+  '.abcd{margin-top:-1px;} '+ ' .logo{text-align:right;margin-right:-1px;top:0;right:0;}   ' + ' .abc{background-color: rgb(212, 212, 212)} '+ '  </style>  </head><body onload="window.print()">' + innerContents + '</html>');
